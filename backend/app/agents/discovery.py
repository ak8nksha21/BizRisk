        ...
        candidates = [
            {
                ...
                # Tags this as a restatement of the investigation's own claimed
                # identity (not independent corroboration), same as the
                # "llm_discovery" tag below distinguishes LLM-proposed
                # candidates. Consulted by entity resolution so this candidate
                # alone can never be trusted to resolve away a genuine
                # statutory-identifier conflict raised by another candidate.
                "source": "intake_echo",
            }
        ]
